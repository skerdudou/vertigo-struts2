...
public final class ApplicationUser implements Entity {
	...
	public io.vertigo.struts2.domain.users.Profil getProfil() {
		final io.vertigo.dynamo.domain.model.URI<io.vertigo.struts2.domain.users.Profil> fkURI = getProfilURI();
		if (fkURI == null) {
			return null;
		}
	...
	public io.vertigo.dynamo.domain.model.URI<io.vertigo.struts2.domain.users.Profil> getProfilURI() {
